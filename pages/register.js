       ...
       <>
            <div className='bg-orange-500 h-screen flex items-center justify-center px-2 py-24 md:px-96 md:py-20'>
                <div className="register-container px-4 md:px-16 bg-white rounded-2xl sm:w-96">
                    ...
                    <div className=' pt-14'>
                        <p className=' uppercase font-bold text-2xl'>Daftar.</p>
                        <p className=' pt-2'>Silahkan melakukan pendaftaran untuk menggunakan </p>
                    </div>
                    <form action='#' method='POST'>
                        ...
                        <button type='sumbit' className='text-xl'>Daftar</button>
                    </form>
                    <div className=' text-center py-10'>
                        Sudah punya akun ?<a href='#' className=' pl-1 font-bold text-orange-400'>Masuk</a>
                    </div>
                </div>
            </div>
            <style jsx>{`
